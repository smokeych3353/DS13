/obj/item/stack/medical
	...
	var/list/rig_chestpiece_covers = list(BP_CHEST, BP_L_ARM, BP_R_ARM, BP_L_LEG, BP_R_LEG)  //dictates what organs the rig chestpiece covers to solve issue of hands not healing and whatnot                                                                                     //if changed let me know, I need to learn -smokey
